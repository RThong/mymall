<template>
	...
	<modal v-bind:mdShow="showConfirmFlag" v-on:close="closeModal()">
		<p slot="message">
			你确定要删除该项商品吗?
		</p>
		<div slot="btnGroup">
			<a class="btn btn--m" href="javascript:;" @click="delProduct()">确认</a>
			<a class="btn btn--m" href="javascript:;" @click="showConfirmFlag=false">关闭</a>
		</div>
	</modal>
