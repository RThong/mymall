	...
	<header class="header">
		...
		<div class="navbar">
			<div class="navbar-left-container">
				<a href="/">
					<img class="navbar-brand-logo" src="static/logo.png" width="180px" height="55px">
				</a>
			</div>
				...
				<div class="md-content">
					<div class="confirm-tips">
						<div class="error-wrap">
							...
							<span class="error error-show" v-show="emptyTip">用户名和密码不能为空</span>
						</div>
						<ul>
							<li class="regi_form_input">
								<i class="icon IconPeople"></i>
								<input type="text" v-model="userName" tabindex="1" name="loginname" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
							</li>
	...
	export default{
		data() {
			return {
				...
				emptyTip: false,//空白输入提示
				loginFlag: false,//模态框开关
				nickName: '',//用户名
			}
		},
		computed: {
